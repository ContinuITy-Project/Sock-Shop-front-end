  ...
  if (name === 'http') {
    ...
    aspect.around(
      ...
      function(obj, methodName, methodArgs, probeData) {
        ...
        Request.addZipkinHeaders(methodArgs[0], global.tracer.createChildId());
        global.tracer.recordServiceName(serviceName);
        global.tracer.recordRpc(requestMethod);
        global.tracer.recordBinary('http.url', urlRequested);
        global.tracer.recordAnnotation(new Annotation.ClientSend());
        // End metrics
        aspect.aroundCallback(
          methodArgs,
          probeData,
          function(target, args, probeData) {
            global.tracer.recordBinary('http.status_code', target.res.statusCode.toString());
            global.tracer.recordAnnotation(new Annotation.ClientRecv());
          },
