...
var randomTraceId = require('../node_modules/zipkin/lib/tracer/randomTraceId');
        ...
        aspect.aroundCallback(args, probeData, function(obj, args, probeData) {
          ...
          if (traceUrl !== '') {
            ...
            if (hasZipkinHeader(httpReq)) {
              const headers = httpReq.headers;
              var spanId = randomTraceId();
              if (spanId !== undefined) {
                const traceId = new Some(headers[(Header.TraceId).toLowerCase()]);
                const parentSpanId = new Some(headers[(Header.SpanId).toLowerCase()]);
            ...
            tracer.recordBinary('cookie',  httpReq.headers.cookie);
            ...
            aspect.after(res, 'end', probeData, function(obj, methodName, args, probeData, ret) {
              ...
              if(res.req.method == "POST" || res.req.method == "PATCH"){
                ...
                tracer.recordBinary('body', JSON.stringify(body));
              }
