...
window.ctxImpl = ctxImpl;

const localServiceName = 'browser';
window.localServiceName = localServiceName;

const logEl = document.getElementById('log');
const log = text => logEl.innerHTML = `${logEl.innerHTML}\n${text}`;

}).call(this,require('_process'))
},{"./recorder":29,"_process":30,"browser-process-hrtime":2,"zipkin":14,"zipkin-instrumentation-fetch":4}],2:[function(require,module,exports){
...
},{"./wrapFetch":5}],5:[function(require,module,exports){
'use strict';
...
},{"zipkin":14}],6:[function(require,module,exports){
(function (global){
'use strict';
...
},{"zipkin":14}],7:[function(require,module,exports){
'use strict';

module.exports.HttpLogger = require('./HttpLogger');
},{"./HttpLogger":6}],8:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./InetAddress":8}],10:[function(require,module,exports){
'use strict';
...
},{"./model":19,"./time":22}],11:[function(require,module,exports){
'use strict';
...
},{"./InetAddress":8,"./annotation":9,"./batch-recorder":10,"./console-recorder":11,"./explicit-context":12,"./httpHeaders":13,"./instrumentation":17,"./jsonEncoder":18,"./model":19,"./option":20,"./request":21,"./tracer":24,"./tracer/TraceId":23,"./tracer/noop":25,"./tracer/sampler":28}],15:[function(require,module,exports){
'use strict';
...
},{"../annotation":9,"../request":21}],16:[function(require,module,exports){
'use strict';
...
},{"../annotation":9,"../httpHeaders":13,"../option":20,"../tracer/TraceId":23}],17:[function(require,module,exports){
'use strict';
...
},{"./httpClient":15,"./httpServer":16}],18:[function(require,module,exports){
'use strict';
...
},{"./httpHeaders":13}],22:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../option":20}],24:[function(require,module,exports){
'use strict';
...
},{"../annotation":9,"../model":19,"../option":20,"../time":22,"./TraceId":23,"./randomTraceId":26,"./record":27,"./sampler":28,"is-promise":3}],25:[function(require,module,exports){
'use strict';
...
},{"../explicit-context":12,"./":24}],26:[function(require,module,exports){
'use strict';
...
},{"../option":20}],29:[function(require,module,exports){
/* eslint-env browser */
const {
  BatchRecorder,
  jsonEncoder: {JSON_V2}
...
},{"zipkin":14,"zipkin-transport-http":7}],30:[function(require,module,exports){
